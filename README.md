...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-billing-pricing-api?sort=semver)](https://github.com/liberusoftware/module-billing-pricing-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-billing-pricing-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-billing-pricing-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-billing-pricing-api
```
...
<a href="https://github.com/liberusoftware/module-billing-pricing-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-billing-pricing-api" alt="Contributors to liberusoftware/module-billing-pricing-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-billing-pricing-api/graphs/contributors).
